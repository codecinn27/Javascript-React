...
function Signin() {
    ...
    const handleSignin = async(e)=>{
        ...
        try{
            const response = await axios.post("http://localhost:5000/api/auth/signin", user, {withCredentials: true}, );
  ...
  return (
    <div className='flex items-center justify-center h-screen bg-gradient-to-r from-green-400 to-blue-500'>
        <form className='w-full max-w-sm bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4' onSubmit={handleSignin}>
            <h3 className='mb-4 text-xl font-bold text-center text-blue-500'>Sign-In</h3>
            <div className='mb-5'>
            ...
            <div className='flex items-center justify-between mb-6'>
                ...
                rounded focus:outline-none focus:shadow-outline' type='submit'>Sign In</button>
                <p className='text-sm text-red-500 hover:text-red-700'>Not registered ?{"  "}
